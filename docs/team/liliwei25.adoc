...
== Project: PocketBook
PocketBook is a desktop address book application targeted at lazy Singaporeans.
...
include::../UserGUide.adoc[tag=birthdaypopup]
...
* `Tutorial` function
** Opens a pop-up dialog with instructions on how to use the application.
** Can be called by using the `tutorial` command
** Also shows when the user opens the application for the first time

==== Justification

When the user calls the `tutorial` function or when the user opens the app for the first time
, a pop-up will show to guide the user through some basic commands such as add, edit, delete, etc.
...
* `Logic`
** Tutorial command parser
** Tutorial

* Design consideration:
** Alternative 1: Use buttons for user to choose when to move on to next step.
** Alternative 2: Detect when the user has entered the correct input and move on to next step.

=== Other contributions

* Code consolidation and review for team repo
